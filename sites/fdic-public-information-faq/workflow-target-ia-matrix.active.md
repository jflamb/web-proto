# Proposed Target IA Matrix (Active Codes Only)

Filtered on **February 24, 2026** to include only action codes observed in active source lists (46 total).

Excluded component-only codes: `failBankList`, `oowebsite`.
...
## Crosswalk: Current Action Code -> Target Path (Active Only)
...
## Path Consolidation Summary (Active Only)
| Target Path ID | Mapped Active Codes |
|---|---:|
| T10_FAILED_BANK_ASSET_AND_REAL_ESTATE | 5 |
| T11_PARTNER_OR_SPECIALIZED_EXTERNAL | 2 |
| T12_SELF_SERVICE_INFORMATION | 8 |
